...
// TypeScript için özellik (props) tiplerini tanımlıyoruz
...
export default function Button({
  ...
  const base = `inline-flex items-center justify-center font-medium rounded-lg transition-all duration-200 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`;
